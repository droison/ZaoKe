...
public class AutoRegHttp implements Runnable {
	private Context context;
	private Handler mHandler;
	private String url;

	public AutoRegHttp(Context context, Handler mHandler, String name) {
		this.context = context;
		this.mHandler = mHandler;
		this.url = AppConstant.HTTPURL.autoreg + "?name=" + name;
	}
