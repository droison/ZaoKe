...
public class VerifyCodeHttp implements Runnable {
	private Context context;
	private Handler mHandler;
	private String url;

	public VerifyCodeHttp(Context context, Handler mHandler, String phone, String userid,String ticket,String code) {
		this.context = context;
		this.mHandler = mHandler;
		this.url = AppConstant.HTTPURL.verifycode + "?phone=" + phone + "&userid=" +userid + "&ticket=" +ticket + "&code=" +code;
	}
