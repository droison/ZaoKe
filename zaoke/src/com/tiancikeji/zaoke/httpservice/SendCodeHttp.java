...
public class SendCodeHttp implements Runnable {
	private Context context;
	private Handler mHandler;
	private String url;

	public SendCodeHttp(Context context, Handler mHandler, String phone, String userid,String ticket) {
		this.context = context;
		this.mHandler = mHandler;
		this.url = AppConstant.HTTPURL.getVerifyCode + "?phone=" + phone + "&userid=" +userid + "&ticket=" +ticket;
	}
